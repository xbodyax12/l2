...
import l2j.luceraV3.gameserver.model.HistoryInfo;
import l2j.luceraV3.gameserver.model.actor.Npc;
import l2j.luceraV3.gameserver.model.actor.template.NpcTemplate;
import l2j.luceraV3.gameserver.model.zone.type.DerbyTrackZone;
import l2j.luceraV3.gameserver.network.SystemMessageId;
import l2j.luceraV3.gameserver.network.serverpackets.DeleteObject;
import l2j.luceraV3.gameserver.network.serverpackets.MonRaceInfo;
import l2j.luceraV3.gameserver.network.serverpackets.PlaySound;
	...
	protected DerbyTrackManager()
	{
		...
		try
		{
			for (int i = 31003; i < 31027; i++)
			{
				...
				final Constructor<?> constructor = Class.forName("l2j.luceraV3.gameserver.model.actor.instance." + template.getType()).getConstructors()[0];
