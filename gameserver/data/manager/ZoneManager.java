...
import l2j.luceraV3.gameserver.model.WorldObject;
import l2j.luceraV3.gameserver.model.WorldRegion;
...
import l2j.luceraV3.gameserver.model.zone.form.ZoneCuboid;
import l2j.luceraV3.gameserver.model.zone.form.ZoneCylinder;
import l2j.luceraV3.gameserver.model.zone.form.ZoneNPoly;
import l2j.luceraV3.gameserver.model.zone.type.BossZone;
import l2j.luceraV3.gameserver.model.zone.type.subtype.SpawnZoneType;
import l2j.luceraV3.gameserver.model.zone.type.subtype.ZoneType;
...
public class ZoneManager implements IXmlReader
{
	...
	public void parseDocument(Document doc, Path path)
	{
		...
		try
		{
			zoneConstructor = Class.forName("l2j.luceraV3.gameserver.model.zone.type." + zoneType).getConstructor(int.class);
		}
		catch (Exception e)
		{
